...
class TfManualInterface(TfInterface):
    ...
    def train_model(self):
        ...
        lr_schedule = tfk.callbacks.ReduceLROnPlateau(
            monitor="val_loss", patience=10, factor=0.5, min_lr=1e-8, verbose=1
        )
        ...
        self._model.fit(
            ...
            **self._training_settings,
            callbacks=[lr_schedule, stop_early],
        )
...
class TfManualLayeredInterface(TfManualInterface):
    ...
    def add_layer(self, layer_id: str, layer_args: dict):
        ...
        if layer_args.get("kernel_regularizer", False):
            ...
            layer_args["kernel_regularizer"] = tfk.regularizers.L2(
                layer_args["kernel_regularizer"]
            )
